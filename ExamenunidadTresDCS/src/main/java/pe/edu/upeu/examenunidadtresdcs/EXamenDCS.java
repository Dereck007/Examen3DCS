...
public class EXamenDCS{
    ...
    public int[][] Transformada6DCS(int dimen, int n){
        ...
        public int[][] Transformada9DCS(int dimensionX, int numInit){
        System.out.println("Ejercicio 9: ");
          ...
          return matriz;
            ...
            public int[][] Transformada12DCS(int dimensionX, int numInit){
    ...
    public int[][] Transformada26DCS(int dimen, int n){
    ...
    public int[][] Transformada30DCS(int dimensionX, int numInit){
    ...
    public void TodoGGMM(){
        ...
        int n=leer.nextInt();
        or.imprimir(or.Transformada6DCS(dimen, n));
        or.imprimir(or.Transformada26DCS(dimen, n));
        or.imprimir(or.Transformada12DCS(dimen, n));
        or.imprimir(or.Transformada30DCS(dimen, n));
        or.imprimir(or.Transformada9DCS(dimen, n));
    }
    public static void main(String[] args) {
        ...
        while (opcion!=0) {            
            switch(opcion){
            case 1: or.imprimir(or.Transformada6DCS(dimen, n)); break;
            case 2: or.imprimir(or.Transformada9DCS(dimen, n)); break;
            case 3: or.imprimir(or.Transformada12DCS(dimen, n)); break;
            case 4: or.imprimir(or.Transformada26DCS(dimen, n)); break;
            case 5: or.imprimir(or.Transformada30DCS(dimen, n)); break;
